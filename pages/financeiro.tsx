              ...
              <div key={item} className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-meguispet-primary/10 rounded-full flex items-center justify-center">
                    <CreditCard className="h-5 w-5 text-meguispet-primary" />
                  </div>
                  <div>
                    <div className="font-medium">Transação #{item}</div>
                    <div className="text-sm text-gray-500">Descrição da transação</div>
                  </div>
                </div>
