    ...
    try {
      ...
      try {
        ...
        if (vendasResponse.success && vendasResponse.data) {
          const vendasFiltradas = vendasResponse.data.filter((venda: any) =>
      ...
      try {
        ...
        if (clientesResponse.success && clientesResponse.data) {
          const clientesFiltrados = clientesResponse.data.filter((cliente: any) =>
