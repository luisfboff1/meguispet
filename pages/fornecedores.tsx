      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium truncate pr-2">Cadastros totais</CardTitle>
            <Building2 className="h-4 w-4 text-meguispet-primary flex-shrink-0" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold whitespace-nowrap">{pagination.total}</div>
            <p className="text-xs text-muted-foreground truncate">Inclui todos os fornecedores ativos</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground truncate">Registros carregados nesta página</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground truncate">Após filtros aplicados</p>
          </CardContent>
        </Card>
      </div>
