...
import { produtosService, clientesService, vendedoresService } from '@/services/api'
...
export default function MovimentacaoForm({ produto, onSubmit, onCancel, loading = false, editingData }: MovimentacaoFormProps) {
  ...
  if (loadingProdutos || loadingClientes || loadingVendedores) {
    return (
          ...
          {produtoSelecionado && (
            <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
              ...
              <div className="text-sm space-y-1">
                ...
                {formData.tipo_movimentacao === 'entrada' && (
                  <p><strong>Fornecedor:</strong> {formData.fornecedor_nome || 'Não informado'}</p>
                )}
