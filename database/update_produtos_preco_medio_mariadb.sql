...
-- 7. Criar view para relatórios de estoque com valores totais
...
ALTER TABLE produtos COMMENT = 'Tabela de produtos com preço médio ponderado';

-- 9. Exemplo de uso das funções (comentado)
/*
-- Exemplo: Entrada de 100 unidades a R$ 15,00
-- CALL atualizar_estoque_preco_medio(1, 100, 15.00, 'entrada');

-- Exemplo: Saída de 50 unidades
-- CALL atualizar_estoque_preco_medio(1, 50, 0, 'saida');
