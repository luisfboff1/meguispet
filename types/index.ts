...
import type { Permissoes, UserRole } from "./permissions";
...
export type { Permissoes, UserRole } from "./permissions";
export {
  getDefaultPermissions,
  isFullAccessRole,
  mergePermissions,
  PERMISSIONS_PRESETS,
  roleRequiresVendedor,
} from "./permissions";
...
export type EstoqueOperacaoTipo =
  | "entrada"
  | "saida"
  | "ajuste"
  | "transferencia";
...
// ============================================================================
// BLING - MAPEAMENTO DE PRODUTOS
// ============================================================================

/** Mapeamento de produto Bling → Produtos Locais */
export interface BlingProdutoMapeamento {
  id: number;
  ...
  ativo: boolean;
  itens?: BlingProdutoMapeamentoItem[];
  created_at: string;
  updated_at: string;
}

/** Item de mapeamento: relação produto Bling → produto local */
export interface BlingProdutoMapeamentoItem {
  id: number;
...
/** Form data para criar/editar mapeamento */
export interface BlingProdutoMapeamentoForm {
  bling_produto_id?: number | null;
  codigo?: string | null;
  descricao: string;
  observacoes?: string | null;
...
/** Produto do Bling não mapeado (para sugestões) */
export interface BlingProdutoNaoMapeado {
  codigo_produto?: string | null;
  descricao: string;
  bling_produto_id?: number | null;
  ocorrencias?: number; // Quantas vezes aparece em vendas
}
